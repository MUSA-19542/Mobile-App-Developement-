...
public class TinyDB {
    ...
    public void putListObject(String key, ArrayList<FoodDataModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodDataModel player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }

    public ArrayList<FoodDataModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodDataModel> playerList =  new ArrayList<FoodDataModel>();

        for(String jObjString : objStrings){
            FoodDataModel player  = gson.fromJson(jObjString,  FoodDataModel.class);
